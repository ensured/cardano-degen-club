...
const sectionVariants = {
  ...
  gradient: {
    className: "bg-gradient-to-br from-background via-muted to-background dark:from-background dark:via-muted dark:to-background relative",
    overlay: (
...
export function Section({ 
  ...
  return (
    ...
    >
      ...
      <div className={cn(
        "relative mx-auto flex h-full flex-col px-6 md:container",
        containerClassName
      )}>
        <motion.div
          initial="hidden"
